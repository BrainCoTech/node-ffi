...
NAN_MODULE_INIT(FFI::InitializeStaticFunctions) {
  ...
  (void) o->Set(context, Nan::New<String>("dlopen").ToLocalChecked(),  WrapPointer((char *)dlopen));
  (void) o->Set(context, Nan::New<String>("dlclose").ToLocalChecked(), WrapPointer((char *)dlclose));
  (void) o->Set(context, Nan::New<String>("dlsym").ToLocalChecked(),   WrapPointer((char *)dlsym));
  (void) o->Set(context, Nan::New<String>("dlerror").ToLocalChecked(), WrapPointer((char *)dlerror));

  (void) o->Set(context, Nan::New<String>("_errno").ToLocalChecked(), WrapPointer((char *)node_ffi_errno));

  (void) target->Set(context, Nan::New<String>("StaticFunctions").ToLocalChecked(), o);
}
...
NAN_MODULE_INIT(FFI::InitializeBindings) {
  ...
  (void) ftmap->Set(context, Nan::New<String>("void").ToLocalChecked(), WrapPointer((char *)&ffi_type_void));
  (void) ftmap->Set(context, Nan::New<String>("uint8").ToLocalChecked(), WrapPointer((char *)&ffi_type_uint8));
  (void) ftmap->Set(context, Nan::New<String>("int8").ToLocalChecked(), WrapPointer((char *)&ffi_type_sint8));
  (void) ftmap->Set(context, Nan::New<String>("uint16").ToLocalChecked(), WrapPointer((char *)&ffi_type_uint16));
  (void) ftmap->Set(context, Nan::New<String>("int16").ToLocalChecked(), WrapPointer((char *)&ffi_type_sint16));
  (void) ftmap->Set(context, Nan::New<String>("uint32").ToLocalChecked(), WrapPointer((char *)&ffi_type_uint32));
  (void) ftmap->Set(context, Nan::New<String>("int32").ToLocalChecked(), WrapPointer((char *)&ffi_type_sint32));
  (void) ftmap->Set(context, Nan::New<String>("uint64").ToLocalChecked(), WrapPointer((char *)&ffi_type_uint64));
  (void) ftmap->Set(context, Nan::New<String>("int64").ToLocalChecked(), WrapPointer((char *)&ffi_type_sint64));
  (void) ftmap->Set(context, Nan::New<String>("uchar").ToLocalChecked(), WrapPointer((char *)&ffi_type_uchar));
  (void) ftmap->Set(context, Nan::New<String>("char").ToLocalChecked(), WrapPointer((char *)&ffi_type_schar));
  (void) ftmap->Set(context, Nan::New<String>("ushort").ToLocalChecked(), WrapPointer((char *)&ffi_type_ushort));
  (void) ftmap->Set(context, Nan::New<String>("short").ToLocalChecked(), WrapPointer((char *)&ffi_type_sshort));
  (void) ftmap->Set(context, Nan::New<String>("uint").ToLocalChecked(), WrapPointer((char *)&ffi_type_uint));
  (void) ftmap->Set(context, Nan::New<String>("int").ToLocalChecked(), WrapPointer((char *)&ffi_type_sint));
  (void) ftmap->Set(context, Nan::New<String>("float").ToLocalChecked(), WrapPointer((char *)&ffi_type_float));
  (void) ftmap->Set(context, Nan::New<String>("double").ToLocalChecked(), WrapPointer((char *)&ffi_type_double));
  (void) ftmap->Set(context, Nan::New<String>("pointer").ToLocalChecked(), WrapPointer((char *)&ffi_type_pointer));
  // NOTE: "long" and "ulong" get Locald in JS-land
  // Let libffi Local "long long"
  (void) ftmap->Set(context, Nan::New<String>("ulonglong").ToLocalChecked(), WrapPointer((char *)&ffi_type_ulong));
  (void) ftmap->Set(context, Nan::New<String>("longlong").ToLocalChecked(), WrapPointer((char *)&ffi_type_slong));

  (void) target->Set(context, Nan::New<String>("FFI_TYPES").ToLocalChecked(), ftmap);
}
...
void FFI::FinishAsyncFFICall(uv_work_t *req) {
  ...
  Nan::AsyncResource resource("nan:test.nancallback");
